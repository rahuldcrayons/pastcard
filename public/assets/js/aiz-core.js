...
(function ($) {
                ...
                $(".aiz-count-down").each(function () {
                    ...
                    $this.countdown(date).on("update.countdown", function (event) {
                        var $this = $(this).html(
                            event.strftime(
                                "" +
                                    '<div class="deals-time time-day"><div class="num-time">%-D</div><div class="title-time">days</div></div>' +
                                    '<div class="deals-time time-hours"><div class="num-time">%H</div><div class="title-time">hours</div></div>' +
                                    '<div class="deals-time time-mins"><div class="num-time">%M</div><div class="title-time">mins</div></div>' +
                                    '<div class="deals-time time-secs"><div class="num-time">%S</div><div class="title-time">secs</div></div>'
                            )
                        );
                    });
                });
    ...
    AIZ.extra = {
        ...
        classToggle: function () {
		    ...
		    $(target+' i').removeClass("la-bars");
		    $(target+' i').addClass("la-times");
                    $this.addClass("active");
                    if(backdrop == 'static'){
        ...
        plusMinus: function(){
            ...
            $('.aiz-plus-minus .quantity-button').on('click', function(e) {
                e.preventDefault();
