...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::post('/bulk-product-approved', 'ProductController@bulk_product_approved')->name('bulk-product-approved');
    ...
    Route::post('/bulk-seller-approved', 'SellerController@bulk_seller_approved')->name('bulk-seller-approved');
    ...
    Route::get('customers_edit_wallet/{customer}', 'CustomerController@edit_wallet')->name('customers.edit_wallet');
    ...
    Route::post('/price_setting/update', 'BusinessSettingsController@price_update')->name('price_setting.update');
    ...
    Route::get('/price_setting', 'BusinessSettingsController@price_setting')->name('price_setting.index');
