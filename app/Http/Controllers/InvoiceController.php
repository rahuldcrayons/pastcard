...
class InvoiceController extends Controller
{
    ...
    public function invoice_download($id)
    {
        ...
        return view('backend.invoices.invoice', compact('order', 'font_family', 'direction', 'text_align', 'not_text_align','config'));
        // dd($font_family,$direction,$text_align,$not_text_align,$config,$order->code);
        ...
        // $pdf = \PDF::loadView('backend.invoices.invoice', compact('order','font_family','direction','text_align','not_text_align'));
