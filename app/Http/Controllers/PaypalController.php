...
use App\Models\Currency as MyCurrency;
...
class PaypalController extends Controller
{
    ...
    public function getCheckout()
    {
		...
		$currencycode = MyCurrency::findOrFail(get_setting('system_default_currency'))->code;
		$productprice =number_format($amount, 2, '.', '');
		$convertamount = thmx_currency_convert($productprice);
        ...
        $request->body = [
                             ...
                             "purchase_units" => [[
                                 ...
                                 "amount" => [
                                     "value" => number_format($convertamount, 2, '.', ''),
                                     "currency_code" => "USD"
                                 ]
                             ]],
                             "application_context" => [
