        ...
        if($canImport) {
            foreach ($rows as $row) {
                ...
                $productId = Product::create([
                            ...
                            'brand_id' => $row['brand_id'] == null ? 0 : $row['brand_id'],
                            ...
                            'slug' => $row['slug'] == null ? preg_replace('/[^A-Za-z0-9\-]/', '', str_replace(' ', '-', strtolower($row['name']))) : preg_replace('/[^A-Za-z0-9\-]/', '', str_replace(' ', '-', strtolower($row['slug']))),
