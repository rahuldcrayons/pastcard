        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{translate('SMS Alert Credential')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                        <input type="hidden" name="otp_method" value="smsalert">
                        @csrf
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="SMSALERT_APIKEY">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('SMSALERT_APIKEY')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="SMSALERT_APIKEY" value="{{  env('SMSALERT_APIKEY') }}" placeholder="SMSALERT_APIKEY" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="SMSALERT_SENDER_ID">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('SMSALERT_SENDER_ID')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="SMSALERT_SENDER_ID" value="{{  env('SMSALERT_SENDER_ID') }}" placeholder="SMSALERT_SENDER_ID" required>
                            </div>
                        </div>
