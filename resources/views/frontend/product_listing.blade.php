            ...
            <form class="" id="search-form" action="" method="GET">
                <div class="row">
                                ...
                                <div class="bg-white shadow-sm rounded mb-3">
                                    ...
                                    <div class="p-3">
                                        <ul class="list-unstyled">
                                            ...
                                            @else
                                                <li class="mb-2">
                                                    <a class="text-reset fs-22 fw-600" href="{{ route('search') }}">
                                                ...
                                                @if (\App\Models\Category::find($category_id)->parent_id != 0)
                                                    <li class="mb-2">
                                                        <a class="text-reset fs-22 fw-600" href="{{ route('products.category', \App\Models\Category::find(\App\Models\Category::find($category_id)->parent_id)->slug) }}">
                                                            <i class="las la-angle-left"></i>
                                                ...
                                                @endif
                                                <li class="mb-2">
                                                    <a class="text-reset fs-22 fw-600" href="{{ route('products.category', \App\Models\Category::find($category_id)->slug) }}">
                                                        <i class="las la-angle-left"></i>
                                                ...
                                                @foreach (\App\Utility\CategoryUtility::get_immediate_children_ids($category_id) as $key => $id)
                                                    <li class="ml-4 mb-2">
                                                        <a class="text-reset fs-22" href="{{ route('products.category', \App\Models\Category::find($id)->slug) }}">{{ \App\Models\Category::find($id)->getTranslation('name') }}</a>
                                                    </li>
                                                @endforeach
                                            @endif
                                        </ul>
                                ...
                                <div class="bg-white shadow-sm rounded mb-3">
                                    ...
                                    <div class="p-3">
                                        <div class="aiz-range-slider">
                                            ...
                                            <div class="row mt-2">
                                                <div class="col-6">
                                                    <span class="range-slider-value value-low fs-22 fw-600 opacity-70"
                                                        @if (isset($min_price))
                                                ...
                                                <div class="col-6 text-right">
                                                    <span class="range-slider-value value-high fs-22 fw-600 opacity-70"
                                                        @if (isset($max_price))
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="row gutters-5 products row-cols-xxl-4 row-cols-xl-3 row-cols-lg-4 row-cols-md-3 row-cols-2">
