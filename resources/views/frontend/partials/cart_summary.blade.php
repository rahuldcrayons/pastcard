<div class="card border-0 shadow-sm rounded">
    <div class="card-header">
        <h3 class=" fw-600 mb-0">{{translate('Summary')}}</h3>
        ...
        <table class="table">
            ...
            <tfoot>
                ...
                <tr class="cart-shipping">
                    ...
                    <td class="text-right">
                        <span class="font-italic">{{ ($subtotal >= get_setting('free_shipping_cost')) ? single_price(0) : single_price($shipping) }}</span>
                    </td>
                </tr>
                ...
                @php
                    ...
                    if($subtotal >= get_setting('free_shipping_cost')) {
                        $total -= $shipping;
                    }
                @endphp
                ...
                <tr class="cart-total">
                    ...
                    <td class="text-right">
                        <strong><span id="finaltotal">{{ single_price($total) }}</span></strong>
                    </td>
                </tr>
            </tfoot>
        </table>
