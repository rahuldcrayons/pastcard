...
<button class="btn btn-sm p-2 d-xl-none" data-toggle="class-toggle" data-backdrop="static" data-target=".aiz-mobile-side-nav" data-same=".mobile-side-nav-thumb">
...
<div class="aiz-user-sidenav-wrap position-relative z-1 shadow-sm">
    <div class="aiz-user-sidenav rounded overflow-auto c-scrollbar-light pb-5 pb-xl-0">
        <div class="p-4 text-xl-center mb-4 border-bottom bg-primary text-white position-relative">
            ...
            <h4 class="h5 mb-1 fw-600">{{ Auth::user()->name }}
                @if (Auth::user()->is_premium == 1)
                <span class="fa fa-star checked"></span>
               {{-- <span style="font-weight: bold; color:blue">(Primium Member)</span> --}}
                {{-- <img src="{{ static_asset('assets/img/star.png') }}" class="image rounded-circle" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/star.png') }}';"> --}}
            @endif
            </h4>
        ...
        <div class="sidemnenu mb-3">
            <ul class="aiz-side-nav-list px-2" data-toggle="aiz-side-menu">
                ...
                @else
                    ...
                    {{-- Club Point addon not installed
            ...
            <div class="text-center">
                <div class="heading-4 strong-700 mb-4">
                    @php
                        ...
                        //}
                    @endphp
                    <small class="d-block  mb-2">{{ translate('Your sold amount (current month)')}}</small>
                    <span class="btn btn-primary fw-600 ">{{ single_price($orderTotal) }}</span>
                </div>
