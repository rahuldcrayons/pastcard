            ...
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    ...
                    <div class="text-center py-4 mb-4">
						...
						<p class="opacity-70 font-italic">{{  translate('Your Traking id will be mailed to you in next 4 working days.') }}</p>
                    </div>
                            ...
                            <div class="col-md-6">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $first_order->shipping_type }}</td>
                                    </tr>
                                    <tr>
