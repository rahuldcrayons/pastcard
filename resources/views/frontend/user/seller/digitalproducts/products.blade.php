    ...
    <div class="card">
        <div class="card-header">
            <div class="col text-center text-md-left">
                <h5 class="mb-md-0 mt-0 h6">{{ translate('All Products') }}</h5>
            </div>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    @foreach ($products as $key => $product)
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="{{route('seller.digitalproducts.edit',  ['id'=>$product->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" class="btn btn-info btn-sm" title="{{ translate('Edit') }}">
                                  <i class="las la-edit"></i>
                                </a>
                                <a class="btn btn-success btn-sm" href="{{route('digitalproducts.download', encrypt($product->id))}}" title="{{ translate('Download') }}">
                                    <i class="las la-download"></i>
                                </a>
                                <a href="javascript:void(0)" class="btn btn-danger btn-sm confirm-delete" data-href="{{route('digitalproducts.destroy', $product->id)}}" title="{{ translate('Delete') }}">
