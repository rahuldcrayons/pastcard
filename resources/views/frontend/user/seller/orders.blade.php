        ...
        <form id="sort_orders" action="" method="GET">
          <div class="card-header row gutters-5">
            <div class="col text-center text-md-left">
              <h5 class="mb-md-0 mt-0 h6">{{ translate('Orders') }}</h5>
            </div>
                        ...
                        @foreach ($orders as $key => $order_id)
                            ...
                            @if($order != null)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="javascript:void(0)" class="btn btn-primary btn-sm" onclick="show_order_details({{ $order->id }})" title="{{ translate('Order Details') }}">
                                            <i class="las la-eye"></i>
                                        </a>
                                        <a href="{{ route('invoice.download', $order->id) }}" class="btn btn-warning btn-sm" title="{{ translate('Download Invoice') }}">
