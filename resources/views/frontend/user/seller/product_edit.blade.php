            ...
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <select class="form-control aiz-selectpicker" name="video_provider" id="video_provider">
                        ...
                        <option value="other" <?php if($product->video_provider == 'other') echo "selected";?>>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <input type="number" lang="en" class="form-control" name="max_qty"
                        value="@if($product->max_qty <= 1){{1}}@else{{$product->max_qty}}@endif" min="1"
                        required>
                </div>
            </div>
            <div class="form-group row">
