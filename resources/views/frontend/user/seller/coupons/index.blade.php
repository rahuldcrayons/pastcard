...
@section('panel_content')
    ...
    <div class="card">
        <div class="card-header row gutters-5">
            <div class="col">
                <h5 class="mb-md-0 mt-0 h6">{{ translate('All Coupons') }}</h5>
            </div>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    @foreach($coupons as $key => $coupon)
                        <tr>
                            ...
                            <td class="text-right">
                                <a class="btn btn-primary btn-sm" href="{{route('seller.coupon.edit', encrypt($coupon->id) )}}" title="{{ translate('Edit') }}">
                                    <i class="las la-edit"></i>
                                </a>
                                <a href="#" class="btn btn-danger btn-sm confirm-delete" data-href="{{route('seller.coupon.destroy', $coupon->id)}}" title="{{ translate('Delete') }}">
