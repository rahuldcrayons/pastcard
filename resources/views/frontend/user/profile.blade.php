...
@section('panel_content')
    ...
    <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 mt-0 h6">{{ translate('Basic Info')}}</h5>
            </div>
            <div class="card-body">
                <div class="form-group row">
                    <label class="col-md-3 col-form-label">{{ translate('Your Name') }}</label>
                    <div class="col-md-9">
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label">{{ translate('Your Phone') }}</label>
                    <div class="col-md-9">
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label">{{ translate('Your Password') }}</label>
                    <div class="col-md-9">
                ...
                {{-- <div class="row">
                    <label class="col-md-3 col-form-label">{{translate('Preferred Delivery Partner')}}</label>
                    <div class="col-md-9">
                        <select name="delivery_partner[]" class="form-control aiz-selectpicker" multiple data-max-options="3" data-live-search="true" data-selected="{{ Auth::user()->seller->delivery_partner }}">
        ...
        @if(Auth::user()->seller)
            ...
            <div class="card">
            <div class="card-header">
                <h5 class="mb-0 mt-0 h6">{{ translate('Payment Setting')}}</h5>
            </div>
            <div class="card-body">
                <div class="row">
				...
				<div class="row mb-3">
					<div class="col-md-6 p-0">
						<label class="col-md-12 col-form-label">{{ translate('Aadhaar Card') }}</label>
						<div class="col-md-12">
							<div class="input-group" data-toggle="aizuploader" data-type="image">
								<div class="input-group-prepend">
									<div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse')}}</div>
								...
								<div class="form-control file-amount">{{ translate('Choose File') }}</div>
								<input type="hidden" name="idfront" value="{{ Auth::user()->idfront }}" class="selected-files">
							</div>
							<div class="file-preview box sm">
							</div>
						</div>
					...
					<div class="col-md-6 p-0">
						<div class="row">
							<label class="col-md-12 col-form-label">{{ translate('Bank Account,Passbook and cheque photo') }}</label>
							<div class="col-md-12">
								<div class="input-group" data-toggle="aizuploader" data-type="image">
									<div class="input-group-prepend">
										<div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse')}}</div>
									...
									<div class="form-control file-amount">{{ translate('Choose File') }}</div>
									<input type="hidden" name="idback" value="{{ Auth::user()->idback }}" class="selected-files">
								</div>
								<div class="file-preview box sm">
								</div>
							</div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 mt-0 h6">{{ translate('Address')}}</h5>
        </div>
        <div class="card-body">
    ...
    <form action="{{ route('user.change.email') }}" method="POST">
        ...
        <div class="card">
          <div class="card-header">
              <h5 class="mb-0 mt-0 h6">{{ translate('Change your email')}}</h5>
          </div>
          <div class="card-body">
              <div class="row">
                  <div class="col-md-2">
