...
@section('panel_content')
    ...
    <div class="row">
        <div class="col-md-4 mx-auto mb-3" >
            <div class="p-3 rounded mb-3 c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition" data-toggle="modal" data-target="#ticket_modal">
                ...
                <div class=" text-primary">{{ translate('Create a Ticket') }}</div>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 mt-0 h6">{{ translate('Tickets')}}</h5>
        </div>
          <div class="card-body">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                  <h5 class="modal-title strong-600 heading-5 mt-0">{{ translate('Create a Ticket')}}</h5>
