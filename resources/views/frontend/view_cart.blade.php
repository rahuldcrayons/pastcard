                ...
                <div class="row aiz-steps arrow-divider">
                    ...
                    <div class="col">
                        <div class="text-center">
                            ...
                            <h3 class="fw-600 d-none d-lg-block opacity-50">{{ translate('2. Shipping info')}}</h3>
                        </div>
                    </div>
                    <div class="col">
                        <div class="text-center">
                                    ...
                                    <li class="list-group-item px-0 px-lg-3">
                                        <div class="row gutters-5">
                                            <div class="col-md-5 d-flex">
                                                ...
                                                <span class="opacity-60"><a href="{{ route('product', $product->slug) }}">{{ $product_name_with_choice }}</a></span>
                                            </div>

                                            <div class="col order-1 order-lg-0 my-3 my-lg-0">
                                                <span class="opacity-60  d-block d-lg-none">{{ translate('Price')}}</span>
                                                <span class="fw-600 ">{{ single_price($cartItem['price']) }}</span>
                                            </div>
                                            <div class="col order-2 order-lg-0 my-3 my-lg-0">
                                                <span class="opacity-60  d-block d-lg-none">{{ translate('Tax')}}</span>
                                                <span class="fw-600 ">{{ single_price($cartItem['tax']) }}</span>
                                            </div>

                                            <div class="col order-4 order-lg-0">
                                                @if($cartItem['digital'] != 1 && $product->auction_product == 0)
                                                    <div class="row no-gutters align-items-center aiz-plus-minus mr-2 ml-0">
                                                        ...
                                                        <input type="number" name="quantity[{{ $cartItem['id'] }}]" class="col border-0 text-center flex-grow-1  input-number" placeholder="1" value="{{ $cartItem['quantity'] }}" min="{{ $product->min_qty }}" max="{{ $product_stock->qty }}" onchange="updateQuantity({{ $cartItem['id'] }}, this)">
                                            ...
                                            <div class="col order-3 order-lg-0 my-3 my-lg-0">
                                                <span class="opacity-60  d-block d-lg-none">{{ translate('Total')}}</span>
                                                <span class="fw-600  text-primary">{{ single_price(($cartItem['price'] + $cartItem['tax']) * $cartItem['quantity']) }}</span>
                                            </div>
                                            <div class="col-lg-auto col order-5 order-lg-0 text-right">
                                                <a href="javascript:void(0)" onclick="removeFromCartView(event, {{ $cartItem['id'] }})" class="btn btn-sm btn-primary btn-circle">
...
@if ($membership_product == 1)
<a href="{{ route('checkout.membership_info') }}" class="btn btn-primary fw-600">
    {{ translate('Purchase Membership')}}
</a>
@else
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        <form class="form-default" role="form" action="{{ route('cart.login.submit') }}" method="POST">
                            ...
                            <div class="form-group">
                             ...
                             @if(get_setting('google_recaptcha') == 1)
                                <div class="form-group">
                                    <div class="g-recaptcha" data-sitekey="{{ $capchakey }}"></div>
                                </div>
                            @endif
                            <div class="row mb-2">
                                <div class="col-6">
                        ...
                        <div class="text-center">
                        <h5>Or</h5>
                        <a href="{{ route('guest.checkout.shipping_info') }}" class="btn btn-secondary ml-2"> Guest Checkout </a>
                        </div>
