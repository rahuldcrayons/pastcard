            ...
            <div class="row">
                <div class="col-md-8 mx-auto">
                    <div class="d-flex justify-content-center" style="background-image: url(@if ($shop->sliders !== null) {{ uploaded_asset($shop->sliders) }} @else {{ static_asset('assets/img/storebg.png') }} @endif);padding: 40px;height:300px;">
                        <div class="row" style="background: rgba(255, 255, 244, 0.23);padding:20px;border-radius:10px;">
							<div class="col-md-4">
								<img
									height="70"
									class="lazyload"
									...
									alt="{{ $shop->name }}" style="max-width:180px;object-fit:cover;"
								>
							</div>
							<div class="col-md-8">
								<div class="p-4 text-left">
									<h1 class="fw-600 h4 mb-0">{{ ucwords($shop->name) }}
									...
									<div class="location opacity-60">{{ ucwords($shop->address) }}</div>
								</div>
							</div>
						</div>
                    </div>
