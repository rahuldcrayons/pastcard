...
<section class="mb-4">
                ...
                <form action="{{ route('payment.checkout') }}" class="form-default" role="form" method="POST" id="checkout-form">
                                        ...
                                        @else
                                            ...
                                            @if(get_setting('cash_payment') == 1)
                                                ...
                                                @if($digital != 1 && $cod_on == 1)
                                                    <div class="col-6 col-md-4">
                                                        <label class="aiz-megabox d-block mb-3">
                                                            <input value="cash_on_delivery" class="online_payment" id="cod" type="radio" name="payment_option">
                                                            <input type="text" name="codselect" id="codselect" value="">
                                                            <span class="d-block p-3 aiz-megabox-elem">
                    ...
                    <div class="row align-items-center pt-3">
                        ...
                        <div class="col-6 text-right">
                            <button type="button" onclick="submitOrder(this)" id="checkoutbtn" class="btn btn-primary fw-600">{{ translate('Complete Order')}}</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="modal" id="codmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-modal="true">
            ...
            <div class="modal-header">
             ...
             <form class="form-default" id="verifyotp" method="POST">
                ...
                <div class="modal-body">
                            ...
                            <div class="title">
                            <p class="info">An otp has been sent to ******9858</p>
                            <p class="msg">Please enter OTP to verify</p>
                            </div>
                            <div class="otp-input-fields">
                            <input type="number" name="1" required class="otp__digit otp__field__1 otpfrm">
                            <input type="number" name="2" required class="otp__digit otp__field__2 otpfrm">
                            <input type="number" name="3" required class="otp__digit otp__field__3 otpfrm">
                            <input type="number" name="4" required class="otp__digit otp__field__4 otpfrm">
                            <input type="number" name="5" required class="otp__digit otp__field__5 otpfrm">
                            <input type="number" name="6" required class="otp__digit otp__field__6 otpfrm">
                            </div>
