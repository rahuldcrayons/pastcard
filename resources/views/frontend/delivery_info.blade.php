            ...
            <div class="row">
                <div class="col-xxl-8 col-xl-10 mx-auto">
                    <form class="form-default" action="{{ route('checkout.store_delivery_info') }}" role="form"
                        ...
                        @if (!empty($admin_products))
                            <div class="card mb-3 shadow-sm border-0 rounded">
                                <div class="card-header p-3">
                                    <h5 class="fw-600 mb-0">{{ get_setting('site_name') }} {{ translate('Products') }}</h5>
                                </div>
                                <div class="card-body">
                                        ...
                                        @foreach ($admin_products as $key => $cartItem)
                                            ...
                                            <li class="list-group-item">
                                                <div class="d-flex">
                                                    ...
                                                    <span class="opacity-60">{{ $product->getTranslation('name') }}</span>
                                                </div>
                                            </li>
                                        @endforeach
                                    </ul>
                                                        ...
                                                        @foreach ($pickup_point_list as $key => $pick_up_point)
                                                            <option value="{{ $pick_up_point->id }}"
                                                                data-content="<span class='d-block'>
                                                                    <span class='d-block  fw-600 mb-2'>{{ $pick_up_point->getTranslation('name') }}</span>
                                                                    <span class='d-block opacity-50 '><i class='las la-map-marker'></i> {{ $pick_up_point->getTranslation('address') }}</span>
                                                                    <span class='d-block opacity-50 '><i class='las la-phone'></i>{{ $pick_up_point->phone }}</span>
                                                                </span>">
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="row gutters-5">
                                                    <div class="col-6">
                                                        <label class="aiz-megabox d-block bg-white mb-0">
                                                            ...
                                                            <span class="d-flex p-3 aiz-megabox-elem">
                                                                <span class="aiz-rounded-check flex-shrink-0 mt-1"></span>
                                                                <span class="flex-grow-1 pl-3 fw-600">Normal
                                                                    Delivery</span>
                                                            </span>
                                                        </label>
                                                    </div>
                                                    <div class="col-6">
                                                        <label class="aiz-megabox d-block bg-white mb-0">
                                                            <input type="radio"
                                                                ...
                                                                value="fast_delivery" onchange="show_pickup_point(this)"
                                                                data-target=".pickup_point_id_{{ $key }}"
                                                                checked>
                                                            <span class="d-flex p-3 aiz-megabox-elem">
                                                                <span class="aiz-rounded-check flex-shrink-0 mt-1"></span>
                                                                <span class="flex-grow-1 pl-3 fw-600">Fast Delivery</span>
                                                            </span>
                                                        </label>
                                                    </div>
                                                    @if ($pickup_point_list)
                        ...
                        <div class="row border-top pt-3">
                            <div class="col-md-6">
                                <h6 class="fw-600">{{ translate('Choose Delivery Type') }}
                                     {{-- @php dd($shipping_types); @endphp --}}
                                    </h6>
                            </div>
                            <div class="col-md-6">
                                <div class="row gutters-5">
                                    ...
                                    <div class="col-6">
                                        <label class="aiz-megabox d-block bg-white mb-0">
                                            <input type="radio" name="shipping_type"
                                                ...
                                                checked
                                                @endif
                                                @if ($shipping_type=='Fast Delivery' && Auth::user()->is_premium == 1)
                                                checked
                                                @endif
                                                >
                                            <span class="d-flex p-3 aiz-megabox-elem">
