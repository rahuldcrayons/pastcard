...
<div class="form-group row">
    <label class="col-lg-3 col-from-label" for="title">{{translate('Title')}}</label>
    <div class="col-lg-9">
        <input type="text" placeholder="{{translate('Title')}}" id="title" name="title" value="{{$coupon->title}}" class="form-control" required>
    </div>
</div>
<div class="form-group row">
    <label class="col-lg-3 col-from-label" for="sub_title">{{translate('Sub Title')}}</label>
    <div class="col-lg-9">
        <input type="text" placeholder="{{translate('Sub Title')}}" id="sub_title" name="sub_title" value="{{$coupon->sub_title}}" class="form-control" required>
    </div>
</div>
<div class="form-group row">
