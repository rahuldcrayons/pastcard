                        ...
                        @foreach ($users as $key => $user)
                            @if ($user != null)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a  data-toggle="modal"
                                            data-target="#editModal{{ $user->id }}" class="btn btn-soft-primary btn-icon btn-circle btn-sm"><i
                                                class="las la-wallet"></i></a>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="editModalLabel">Add Wallet Amount</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('customers.edit_wallet', encrypt($user->id)) }}"  method="GET">
                                                            @csrf
