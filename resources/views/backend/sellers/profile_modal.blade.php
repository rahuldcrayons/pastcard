<div class="modal-body">
  ...
  <div class="row">
	  <div class="col-md-6">
		<p>{{translate('Aadhaar Card')}}</p>
		<img src="{{ uploaded_asset($seller->user->idfront) }}" width="150px"/>
	  </div>
	  <div class="col-md-6">
		<p>{{translate('Bank Account,Passbook and cheque photo')}}</p>
		<img src="{{ uploaded_asset($seller->user->idback) }}" width="150px" />
	  </div>  
  </div>
  <br>
