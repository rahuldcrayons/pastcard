    ...
    <div class="card">
        ...
        <div class="card-body">
          <form action="{{ route('sellers.update', $seller->id) }}" method="POST">
                ...
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="email">Commission</label>
                    <div class="col-sm-9">
                        <input type="text" placeholder="Commission" id="commission" name="commission" class="form-control" value="{{$seller->commission}}" required>
                    </div>
                </div>
                <div class="form-group row">
