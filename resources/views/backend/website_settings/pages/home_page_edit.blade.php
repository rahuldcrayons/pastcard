...
<div class="row">
    <div class="col-xl-10 mx-auto">
        ...
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0">{{ translate('Home Banner 1 (Max 5)') }}</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0">{{ translate('Home Categories Top') }}</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        ...
                        <div class="home-categories-top-target">
                            <input type="hidden" name="types[]" value="home_categories_top">
                            @if (get_setting('home_categories_top') != null)
                                @foreach (json_decode(get_setting('home_categories_top'), true) as $key => $value)
                                    <div class="row gutters-5">
                                        <div class="col">
                                            <div class="form-group">
                                                <select class="form-control aiz-selectpicker" name="home_categories_top[]" data-live-search="true" data-selected={{ $value }} required>
                        ...
                        <button
                            ...
                            data-content='<div class="row gutters-5">
                                <div class="col">
                                    <div class="form-group">
                                        <select class="form-control aiz-selectpicker" name="home_categories_top[]" data-live-search="true" required>
                            ...
                            data-target=".home-categories-top-target">
                            {{ translate('Add New') }}
                        </button>
                    </div>
                    <div class="text-right">
        ...
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0">{{ translate('Home Categories Bottom') }}</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label>{{ translate('Categories') }}</label>
                        <div class="home-categories-bottom-target">
                            <input type="hidden" name="types[]" value="home_categories_bottom">
                            @if (get_setting('home_categories_bottom') != null)
                                @foreach (json_decode(get_setting('home_categories_bottom'), true) as $key => $value)
                                    <div class="row gutters-5">
                                        <div class="col">
                                            <div class="form-group">
                                                <select class="form-control aiz-selectpicker" name="home_categories_bottom[]" data-live-search="true" data-selected={{ $value }} required>
                                                    @foreach (\App\Models\Category::where('parent_id', 0)->with('childrenCategories')->get() as $category)
                                                        <option value="{{ $category->id }}">{{ $category->getTranslation('name') }}</option>
                                                        @foreach ($category->childrenCategories as $childCategory)
                                                            @include('categories.child_category', ['child_category' => $childCategory])
                        ...
                        <button
                            ...
                            data-content='<div class="row gutters-5">
                                <div class="col">
                                    <div class="form-group">
                                        <select class="form-control aiz-selectpicker" name="home_categories_bottom[]" data-live-search="true" required>
                                            @foreach (\App\Models\Category::all() as $key => $category)
                                                <option value="{{ $category->id }}">{{ $category->getTranslation('name') }}</option>
                                            @endforeach
                                        </select>
                            ...
                            data-target=".home-categories-bottom-target">
                            {{ translate('Add New') }}
                        </button>
                    </div>
                    <div class="text-right">
