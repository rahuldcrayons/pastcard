        ...
        <div class="card-header row gutters-5">
            ...
            <div class="dropdown mb-2 mb-md-0">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="#" onclick="bulk_approved()"> {{translate('Approve selection')}}</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row gutters-5 w-200px w-md-300px mw-100">
								...
								@else
									@php
										$productglarry = json_decode($product->photos);
										if(is_array($productglarry)){
											$imagethumb = $productglarry[0];
										}else{
											$imagethumb = $productglarry;
										}
									@endphp
									<img src="{{ uploaded_asset($imagethumb)}}" alt="Image" class="size-50px img-fit">
								@endif
                                </div>
                                <div class="col">
...
@section('script')
    <script type="text/javascript">
        ...
        function bulk_approved() {
            var data = new FormData($('#sort_products')[0]);
            $.ajax({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                url: "{{route('bulk-product-approved')}}",
                type: 'POST',
                data: data,
                cache: false,
                contentType: false,
