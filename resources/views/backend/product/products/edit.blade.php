    ...
    <form class="form form-horizontal mar-top" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
        <div class="row gutters-5">
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control aiz-selectpicker" multiple  name="category_id[]" id="category_id" data-selected="{{ $product->category_id }}" data-live-search="true"  required>
                        ...
                        <div class="form-group row" id="condition">
                            <label class="col-lg-3 col-from-label">{{translate('Condition')}}</label>
                            <div class="col-lg-8">
                                <select class="form-control aiz-selectpicker" name="condition" id="condition_id" data-live-search="true">
                        ...
                        <div class="form-group row @if($product->comic != 1) d-none @endif" id="comic_condition">
                            <div class="col-md-6">
                                <div class="row">
                                    <label class="col-md-6 col-from-label">{{translate('Original')}}</label>
                                    <div class="col-md-6">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="checkbox" name="condition_original" value="1" @if($product->condition_original == 1) checked @endif>
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <label class="col-md-6 col-from-label">{{translate('Reprint')}}</label>
                                    <div class="col-md-6">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="checkbox" name="condition_reprint" value="1" @if($product->condition_reprint == 1) checked @endif>
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control aiz-selectpicker" name="video_provider" id="video_provider">
                                    ...
                                    <option value="other" <?php if($product->video_provider == 'other') echo "selected";?>>{{translate('Other')}}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row video_link <?php if($product->video_provider == 'other') echo "d-none";?>">
                        ...
                        <div class="form-group row video_upload <?php if($product->video_provider !== 'other') echo "d-none";?>">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Gallery Video')}}</label>
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="aizuploader" data-type="video" data-multiple="false">
                                    ...
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                    <input type="hidden" name="videos" value="{{ $product->videos }}" class="selected-files">
                                </div>
                                <div class="file-preview box sm">
                                </div>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label">{{translate('Maximum Purchase Qty')}}</label>
                            <div class="col-lg-8">
                                <input type="number" lang="en" class="form-control" name="max_qty" value="@if($product->max_qty <= 1){{1}}@else{{$product->max_qty}}@endif" min="1" required>
                            </div>
                        </div>
                        <div class="form-group row">
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Product Is Comic')}}</h5>
                    </div>
                    <div class="card-body p-2 pl-4 pr-4">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="comic" value="1" @if($product->comic == 1) checked @endif id="comic_id">
                                    <span></span>
                                </label>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Product Is Coin')}}</h5>
                    </div>
                    <div class="card-body p-2 pl-4 pr-4">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="checkbox" name="coin" value="1" @if($product->coin == 1) checked @endif>
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="est_shipping_days" value="{{ $product->est_shipping_days }}"  placeholder="{{translate('Shipping Days')}}">
                                <div class="input-group-prepend">
...
<script type="text/javascript">
    ...
    $('#video_provider').on('change', function(e) {
    ...
    $('#comic_id').on('change', function(e) {
        if(e.target.checked) {
            $('#comic_condition').removeClass('d-none');
        } else {
            $('#comic_condition').addClass('d-none');
        }
    });
