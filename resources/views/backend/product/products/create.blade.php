            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" multiple name="category_id[]" id="category_id" data-live-search="true" required>
                        ...
                        <div class="form-group row" id="condition">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control aiz-selectpicker" name="condition" id="condition_id" data-live-search="true">
                                    ...
                                    <option value="{{ $condition }}" @if($condition == 'Average') selected @endif>{{ $condition }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>

                        <div class="form-group row d-none" id="comic_condition">
                            <div class="col-md-6">
                                <div class="row">
                                    <label class="col-md-6 col-from-label">{{translate('Original')}}</label>
                                    <div class="col-md-6">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="checkbox" name="condition_original" value="1">
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="checkbox" name="condition_reprint" value="1">
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row video_link">
                        ...
                        <div class="form-group row d-none video_upload">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="unit" placeholder="{{ translate('Unit (e.g. KG, Pc etc)') }}" value="Piece">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Maximum Purchase Qty')}} <span class="text-danger">*</span></label>
                            <div class="col-md-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-2 pl-4 pr-4">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="comic" value="1" id="comic_id">
                                    <span></span>
                                </label>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body p-2 pl-4 pr-4">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="coin" value="1" id="coin_id">
                                    <span></span>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="est_shipping_days" value="10" placeholder="{{translate('Shipping Days')}}">
                                <div class="input-group-prepend">
