            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">{{translate('GST No.')}}</label>
                            <div class="col-sm-9">
                                <input type="hidden" name="types[]" value="gst_no">
                                <input type="text" name="gst_no" class="form-control" value="{{ get_setting('gst_no') }}">
                            </div>
                        </div>
                        <div class="form-group row">
